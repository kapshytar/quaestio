...
Older entries moved out of [CHANGELOG.md](./CHANGELOG.md) to keep the active
changelog small. Only versions `2.3.6` and older live here. When the active
changelog grows past ~50 lines, move older minor blocks down here too.
